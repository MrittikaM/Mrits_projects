...
DROP table if exists OverallRating;

--
-- Table structure for table `OverallRating`
--
Create table OverallRating (
Rating_id  int NOT NULL AUTO_INCREMENT,
order_id int NOT NULL,
Rating  TINYINT(1) unsigned NOT NULL,
RatingTimeStamp TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
PRIMARY KEY (Rating_id),
KEY fk_OR_order_id (order_id),
CONSTRAINT fk_OR_order_id FOREIGN KEY (order_id) REFERENCES `order` (order_id),
CONSTRAINT CHK_Rating CHECK (Rating>0 AND Rating<6)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=latin1;

--
-- Table structure for table `RestaurantlRating`
--
Create table RestaurantRating (
Rating_id  int NOT NULL,
Rating_Rest_Qstn_1 TINYINT(1) unsigned NOT NULL,
Rating_Rest_Qstn_2 TINYINT(1) unsigned NOT NULL,
Rating_Rest_Qstn_3 TINYINT(1) unsigned NOT NULL,
Rating_Rest_Qstn_4 TINYINT(1) unsigned NOT NULL,
PRIMARY KEY (Rating_id),
KEY fk_RR_Rating_id (Rating_id),
CONSTRAINT fk_RR_Rating_id FOREIGN KEY (Rating_id) REFERENCES OverallRating (Rating_id),
CONSTRAINT CHK_Rating_Rest_Qstn_1 CHECK (Rating_Rest_Qstn_1>0 AND Rating_Rest_Qstn_1<6),
CONSTRAINT CHK_Rating_Rest_Qstn_2 CHECK (Rating_Rest_Qstn_2>0 AND Rating_Rest_Qstn_2<6),
CONSTRAINT CHK_Rating_Rest_Qstn_3 CHECK (Rating_Rest_Qstn_3>0 AND Rating_Rest_Qstn_3<6),
CONSTRAINT CHK_Rating_Rest_Qstn_4 CHECK (Rating_Rest_Qstn_4>0 AND Rating_Rest_Qstn_4<6)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=latin1;
...
Rating_id  int NOT NULL,
Rating_Driver_Qstn_1 TINYINT(1) unsigned NOT NULL,
Rating_Driver_Qstn_2 TINYINT(1) unsigned NOT NULL,
Rating_Driver_Qstn_3 TINYINT(1) unsigned NOT NULL,
Rating_Driver_Qstn_4 TINYINT(1) unsigned NOT NULL,
PRIMARY KEY (Rating_id),
KEY fk_DR_Rating_id (Rating_id),
CONSTRAINT fk_DR_Rating_id FOREIGN KEY (Rating_id) REFERENCES OverallRating (Rating_id),
CONSTRAINT CHK_Rating_Driver_Qstn_1 CHECK (Rating_Driver_Qstn_1>0 AND Rating_Driver_Qstn_1<6),
CONSTRAINT CHK_Rating_Driver_Qstn_2 CHECK (Rating_Driver_Qstn_2>0 AND Rating_Driver_Qstn_2<6),
CONSTRAINT CHK_Rating_Driver_Qstn_3 CHECK (Rating_Driver_Qstn_3>0 AND Rating_Driver_Qstn_3<6),
CONSTRAINT CHK_Rating_Driver_Qstn_4 CHECK (Rating_Driver_Qstn_4>0 AND Rating_Driver_Qstn_4<6)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=latin1;
...
Question_Target ENUM('Resturant','Driver'),
Question_Number TINYINT(1) unsigned NOT NULL,
Question varchar(500),
QuestionTimeStamp TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
PRIMARY KEY (Question_id),
CONSTRAINT CHK_Question_Number CHECK (Question_Number>0 AND Question_Number<5)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `OverallRating`
--
INSERT INTO `OverallRating` (`order_id`,`Rating`) VALUES (44,5),(70,4),(97,2),(49,1),(61,3),(37,3),(60,2),(17,2),(50,1),(54,4);
INSERT INTO `OverallRating` (`order_id`,`Rating`) VALUES (78,4),(35,4),(36,2),(58,4),(98,4),(6,2),(31,3),(93,1),(20,3),(85,1);
INSERT INTO `OverallRating` (`order_id`,`Rating`) VALUES (56,5),(59,3),(84,3),(71,3),(55,2),(47,3),(26,3),(87,5),(11,4),(80,4);
INSERT INTO `OverallRating` (`order_id`,`Rating`) VALUES (7,1),(89,3),(8,4),(25,4),(30,5),(12,4),(96,5),(34,5),(75,4),(95,5);
INSERT INTO `OverallRating` (`order_id`,`Rating`) VALUES (72,5),(2,3),(33,3),(43,2),(99,5),(65,5),(42,5),(1,4),(74,1),(10,5);

--
-- Dumping data for table `RestaurantRating`
--
INSERT INTO `RestaurantRating` (`Rating_id`,`Rating_Rest_Qstn_1`,`Rating_Rest_Qstn_2`,`Rating_Rest_Qstn_3`,`Rating_Rest_Qstn_4`) VALUES (1,2,5,3,3),(2,1,4,1,4),(3,4,4,5,5),(4,4,3,3,5),(6,2,4,4,5),(7,5,4,2,3),(8,1,3,3,1),(11,1,1,5,1),(12,3,4,2,3),(14,4,2,1,1);
INSERT INTO `RestaurantRating` (`Rating_id`,`Rating_Rest_Qstn_1`,`Rating_Rest_Qstn_2`,`Rating_Rest_Qstn_3`,`Rating_Rest_Qstn_4`) VALUES (16,4,1,5,1),(17,2,3,3,5),(18,2,1,1,2),(19,1,4,4,4),(20,1,3,4,4),(21,3,1,4,4),(22,5,2,3,2),(23,4,3,3,1),(24,4,3,1,1),(25,4,4,1,4);
INSERT INTO `RestaurantRating` (`Rating_id`,`Rating_Rest_Qstn_1`,`Rating_Rest_Qstn_2`,`Rating_Rest_Qstn_3`,`Rating_Rest_Qstn_4`) VALUES (26,3,3,4,1),(28,3,2,3,2),(30,3,3,4,4),(31,3,1,5,5),(32,2,5,4,3),(33,1,1,3,5),(34,1,3,4,4),(35,1,5,2,1),(48,5,2,2,3),(36,1,2,5,3);
INSERT INTO `RestaurantRating` (`Rating_id`,`Rating_Rest_Qstn_1`,`Rating_Rest_Qstn_2`,`Rating_Rest_Qstn_3`,`Rating_Rest_Qstn_4`) VALUES (37,3,5,3,5),(38,1,3,4,2),(40,1,5,1,5),(42,3,4,1,5),(43,5,2,2,5),(44,3,2,1,3),(45,2,1,1,5),(47,3,5,1,4),(49,1,1,4,2),(50,4,2,2,4);

--
-- Dumping data for table `DriverRating`
--
INSERT INTO `DriverRating` (`Rating_id`,`Rating_Driver_Qstn_1`,`Rating_Driver_Qstn_2`,`Rating_Driver_Qstn_3`,`Rating_Driver_Qstn_4`) VALUES (1,3,2,5,2),(2,2,3,2,1),(3,3,5,1,5),(4,5,5,2,2),(5,3,5,4,3),(7,2,5,4,2),(8,1,1,1,2),(10,4,4,1,4),(11,2,4,4,4);
INSERT INTO `DriverRating` (`Rating_id`,`Rating_Driver_Qstn_1`,`Rating_Driver_Qstn_2`,`Rating_Driver_Qstn_3`,`Rating_Driver_Qstn_4`) VALUES (16,1,1,2,4),(17,2,3,5,4),(18,5,5,3,5),(19,2,3,1,5),(20,2,2,4,3),(21,4,2,4,2),(22,5,1,3,5),(23,4,4,4,5),(24,5,2,1,2),(25,1,5,4,4);
INSERT INTO `DriverRating` (`Rating_id`,`Rating_Driver_Qstn_1`,`Rating_Driver_Qstn_2`,`Rating_Driver_Qstn_3`,`Rating_Driver_Qstn_4`) VALUES (26,4,1,5,4),(27,1,3,4,5),(28,1,1,4,2),(31,2,5,2,5),(32,5,4,1,5),(33,1,4,3,2),(34,3,4,3,2),(35,3,3,2,2),(48,2,1,1,3),(36,3,5,3,4);
INSERT INTO `DriverRating` (`Rating_id`,`Rating_Driver_Qstn_1`,`Rating_Driver_Qstn_2`,`Rating_Driver_Qstn_3`,`Rating_Driver_Qstn_4`) VALUES (38,5,4,5,2),(40,2,5,5,5),(41,2,5,3,3),(42,4,5,5,4),(43,4,3,3,1),(44,3,5,5,1),(46,1,4,4,3),(47,1,4,2,2),(49,4,3,3,2),(50,4,1,3,1);

--
-- Dumping data for table `RatingQuestion`
--
INSERT INTO `RatingQuestion` (`Question_Target`,`Question_Number`,`Question`) VALUES 
("Resturant",1,"How would you rate the food quality?"),
("Resturant",2,"How do you rate the options on the menu?"),
("Resturant",3,"How would you rate the service of food order?"),
("Resturant",4,"How likely is it that you would recommend this restuarant to a friend/colleague"),
("Driver",1,"How do you rate the behavior and corteousness of the driver?"),
("Driver",2,"How would you rate the speed of food delivery services?"),
("Driver",3,"How would you rate the delivery service meeting your overall expectations?"),
("Driver",4,"How likely is it that you would recommend this driver to a friend/colleague"),
("Resturant",2,"How do you rate the value for the prices paid?"),
("Resturant",2,"How do you rate the freshness and taste of the food?");

--
-- Update Timestamps
--
UPDATE overallrating SET RatingTimeStamp = '20210315' where Rating_id < 49;
UPDATE overallrating SET RatingTimeStamp = '20210215' where Rating_id <35;
UPDATE overallrating SET RatingTimeStamp = '20210115' where Rating_id <20;

Update RatingQuestion set QuestionTimeStamp = '20210101' where question_id < 9;
Update RatingQuestion set QuestionTimeStamp = '20210214' where question_id = 9;
Update RatingQuestion set QuestionTimeStamp = '20210314' where question_id = 10;
